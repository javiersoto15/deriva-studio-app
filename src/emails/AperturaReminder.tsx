...
export type AperturaReminderProps = {
  /** Pre-formatted 12-char Crockford code from backend `display_code`, e.g. `K3M9-FQ7X-2VWP`. */
  displayCode: string;
};

export const AperturaReminderSubject =
  "Por si aún no pasas — hasta el sábado 30";

export const AperturaReminderPreview =
  "Si aún no has venido a buscar tu primer café de la carta, sigue en pie hasta el sábado 30 de mayo.";

export default function AperturaReminder({
  displayCode = "K3M9-FQ7X-2VWP",
}: AperturaReminderProps) {
  return (
    <Html lang="es">
      <Head>
      ...
      <Preview>{AperturaReminderPreview}</Preview>
      <Body
        style={{
          margin: 0,
          padding: 0,
              ...
              <tbody>
                <tr>
                  ...
                  >
                    ...
                    >
                      Llevamos una semana abiertos en Providencia. Si aún no
                      has venido a buscar tu primer café de la carta, sigue en
                      pie a tu nombre.
                    </Text>
                    <Text
                      style={{
                    ...
                    >
                      Pasa por la barra con este código antes del{" "}
                      <strong style={{ fontWeight: 600, color: c.ink }}>
                        sábado 30 de mayo
                      </strong>
                      . Después de esa fecha, la ronda se cierra.
                    </Text>
                    <Text
                      style={{
                        margin: "14px auto 0",
                    ...
                    >
                      Tu código aparece abajo — guárdalo en el teléfono, basta
                      con mostrarlo en la barra.
                    </Text>
                      ...
                      <tbody>
                        <tr>
                          ...
                          >
                            ...
                            >
                              Vence el sábado 30 de mayo a las 21:00. No es
                    ...
                    >
                      <tbody>
                        ...
                        <DetailRow label="Horario" value="Lun–Vie 08:00 — 21:00 · Sábado 10:00 — 21:00" />
                        <DetailRow
                          label="Vence"
                          value="Sábado 30 de mayo, 21:00"
                          last
                        />
                      </tbody>
                    </table>
...
AperturaReminder.PreviewProps = {
  displayCode: "K3M9-FQ7X-2VWP",
} satisfies AperturaReminderProps;
